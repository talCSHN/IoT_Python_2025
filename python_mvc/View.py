...
class WindowApp(Tk):
    ...
    def initWindow(self):
        ...
        self.sendButton = Button(self.inputFrame, text='전송', bg='green', fg='white', font=self.myFont, command=self.controller.responseMessage)
    ...
    def keypress(self, event):
        if event.char == '\r':
            self.controller.responseMessage()
